...
# The base image's preinstalled setuptools vendors its own old copy of
# jaraco.context under setuptools/_vendor/, which Trivy flags (CVE-2026-23949)
# independently of whatever jaraco.context version requirements.txt resolves
# for the standalone package. Only upgrading setuptools itself replaces that
# vendored copy.
RUN pip install --no-cache-dir --upgrade "setuptools>=80.9.0"
